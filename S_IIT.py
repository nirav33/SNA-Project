...
professor_urls = [
    "https://scholar.google.com/citations?user=1Yl1h_YAAAAJ",  
    "https://scholar.google.com/citations?user=UBXqggoAAAAJ", 
    "https://scholar.google.com/citations?user=bmQ917cAAAAJ"
]
...
# Save to CSV
df.to_csv("iit_professor_citation_data.csv", index=True)
print("Data saved to iit_professor_citation_data.csv")